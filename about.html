...
<button class="navbar-button button" data-toggle="modal">
  ...
  <div class="header-internal">
    <div class="header-content-internal">
      ...
      <div class="header-title header-title-internal">о компании</div>
      <nav class="crumbs">
        <ul class="nav-crumbs-list">
          <li><a href="#" class="nav-crumbs">Главная</a></li>
          <li><a href="#" class="nav-crumbs">О компании</a></li>
        </ul>
      </nav>
    </div>
  </div>
        ...
        <div class="container">
          <div class="footer-wrapper">
            <div class="footer-legal">
              <p class="footer-copyright">© 2022 «Aliance Production». Все права защищены.</p>
