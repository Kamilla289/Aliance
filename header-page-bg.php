...
<button class="navbar-button button" data-toggle="modal">
  ...
  <div class="header-internal header-internal-bg">
    <div class="header-content-internal">
      <div class="seporator seporator-internal"></div>
      <div class="header-title header-title-internal header-white"><?= $page_title ?></div>
      <nav class="crumbs">
        <ul class="nav-crumbs-list nav-crumbs-list-white">
          <li><a href="#" class="nav-crumbs nav-crumbs-white">Главная</a></li>
          <li><a href="#" class="nav-crumbs nav-crumbs-white">Блог</a></li>
          <li><a href="#" class="nav-crumbs nav-crumbs-white"><?= $page_title ?></a></li>
        </ul>
      </nav>
    </div>
  </div>